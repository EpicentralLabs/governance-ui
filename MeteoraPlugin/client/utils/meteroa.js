...
function setupDLMM() {
    return __awaiter(this, void 0, void 0, function () {
        var rpc, connection, USDC_USDT_POOL, dlmmPool;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rpc = process_1.env.RPC || 'https://api.mainnet-beta.solana.com';
                    connection = new web3_js_1.Connection(rpc);
                    USDC_USDT_POOL = new web3_js_1.PublicKey('ARwi1S4DaiTG5DX7S4M4ZsrXqpMD1MrTmbu9ue2tpmEq');
                    return [4 /*yield*/, dlmm_1.default.create(connection, USDC_USDT_POOL)];
                case 1:
                    dlmmPool = _a.sent();
...
setupDLMM().catch(function (error) {
